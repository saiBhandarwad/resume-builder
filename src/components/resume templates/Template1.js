        ...
        <>
            <div className=" min-h-[100vh] m-auto px-4 pt-1 sm:hidden" id='divcontentstoshow'>
                <div className="w-[90%] border-2 pb-1 mx-auto h-full ">
                    <div className="flex justify-center content-center pt-2 pb-2 h-1/5">
                        <div>
...
<div ref={componentRef} className=" min-h-[100vh] m-auto px-4 pt-4 opacity-0 sm:opacity-100" id='divcontents'>
                <div className="w-[90%] pb-4 mx-auto h-full ">
                    <div className="flex justify-center content-center pt-16 pb-8 h-1/5">
                        <div>
                            <div className='flex justify-center font-semibold text-3xl space-y-2'>{firstName} {middleName} {lastName}</div>
                            <div className='font-medium text-base flex justify-center'>{city} {state} {country}</div>
                            <div className='font-medium text-base space-y-2 flex justify-center'>{phone} {phone ? "|" : null} {email}</div>
                        </div>
                    ...
                    {/* Objective section */}
                    <div className='pl-2 pt-4' id='objective'>
                        <span className=' font-semibold text-lg'>Objective</span>
                        <hr className='pb-4 text-black border-1 border-black' />
                        <span className="mt-4 pl-6">
                            {objective}
                        </span>
                    </div>

                    {/* Achievments section */}
                    <div className='px-2 pt-4' id='achievment'>
                    ...
                    {/* experience section */}
                    <div className='px-2 pt-4' id='experience'>
